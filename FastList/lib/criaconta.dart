...
class criapage extends StatefulWidget {
  @override
  _CriaPageState createState() => _CriaPageState();
}

class _CriaPageState extends State<criapage> {
              ...
              ElevatedButton(
                onPressed: () {
                  Navigator.of(context).push(
                      MaterialPageRoute(builder: (context) => crialista()));
                },
